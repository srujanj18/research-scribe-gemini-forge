...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-muted via-background to-muted">
      ...
      {/* Hero Section */}
      <section className="py-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-0 bg-gradient-to-b from-white via-slate-50 to-slate-100 min-h-[60vh] flex flex-col justify-center">
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6 bg-gradient-academic bg-clip-text text-transparent leading-tight">
              AI Research Paper Generator & Reviewer
            </h2>
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 leading-relaxed">
              Generate, summarize, and review academic papers with advanced AI. Powered by Gemini Pro 1.5, LangChain workflows, and arXiv integration for comprehensive research assistance.
            </p>
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4">
              <Button 
                ...
                className="min-w-40 shadow-md hover:scale-105 transition-transform"
              >
      ...
      {/* Features Grid */}
      <section className="py-8 px-2 sm:px-4 md:px-8 lg:px-12 xl:px-0">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {features.map((feature, index) => (
              <Card 
                key={index} 
                className="group hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 cursor-pointer border-border/50 bg-white/90 backdrop-blur-md rounded-xl"
                onClick={() => setActiveTab(feature.tab)}
              >
                <CardHeader className="pb-4 flex flex-col items-center">
                  <div className="p-3 bg-gradient-academic rounded-lg w-fit mb-3 group-hover:scale-110 transition-transform shadow-md">
      ...
      {/* Main Interface */}
      <section className="py-4 px-2 sm:px-4 md:px-8 lg:px-12 xl:px-0">
        <div className="container mx-auto">
          <Card className="shadow-elevated border-border/50 rounded-2xl bg-white/95">
            <CardHeader>
              <CardTitle className="text-2xl font-bold">Research Tools</CardTitle>
              <CardDescription>
