    ...
    setTimeout(() => {
      ...
      if (type === "plagiarism") {
        setResults({
          ...
          matches: [
            {
              source: "arXiv:2204.01234 - Deep Learning for Medical Imaging",
              similarity: 85,
              text: "Convolutional neural networks have shown remarkable success in medical image analysis...",
              concern: "high"
            },
            {
              source: "IEEE CVPR 2022 - Vision Transformers in Healthcare",
              similarity: 72,
              text: "The attention mechanism allows models to focus on relevant image regions...",
              concern: "medium"
            },
            {
              source: "Nature Medicine 2023 - AI in Radiology",
              similarity: 45,
              text: "Medical image segmentation remains a challenging task...",
              concern: "low"
            }
          ]
        });
        ...
        setResults({
          ...
          noveltyScore: 78,
          analysis: {
            methodology: "Highly novel - combines transformer attention with U-Net architecture in a unique way",
            application: "Moderately novel - medical image segmentation is well-studied but specific approach is new",
            dataset: "Standard datasets used - ImageNet, MIMIC-CXR commonly used in literature",
            evaluation: "Novel evaluation protocol - introduces new metrics for clinical relevance"
          },
          similarWorks: [
          ...
          gaps: [
            "Limited exploration of multi-modal medical data integration",
            "Lack of real-time processing capabilities analysis",
        ...
        setResults({
          ...
          trends: [
            "Increasing focus on transformer architectures (2017-2023)",
            "Growing interest in multi-modal learning (2020-2023)",
            "Shift from pure CNN to hybrid architectures (2018-2023)"
          ],
          clusters: [
            { name: "Computer Vision", papers: 18, strength: 0.85 },
            { name: "Medical AI", papers: 15, strength: 0.78 },
            { name: "Deep Learning", papers: 12, strength: 0.72 },
            { name: "Attention Mechanisms", papers: 8, strength: 0.65 }
          ]
        });
      }
